...
public class RecommendBean { private String user_pic; //用户图片地址
    ...
    private int owner_id;  //用户id
    private int place_id;  //地点id
    private String like_TF;

    public RecommendBean(String like_TF,String notes_id,String user_pic, String user_name, String create_time, String content_text, String place_name, String comment_num, String like_num) {
